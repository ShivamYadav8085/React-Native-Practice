...
const Login = (props:any) => (
    <View style={[styles.container]}>
        ...
        <TouchableOpacity  onPress={()=>props.navigation.navigate("Register")}><Text style={{fontSize:15,fontWeight:"bold",color:"blue",marginTop:70}}>Register</Text></TouchableOpacity>
        </View>
    </View>
)
